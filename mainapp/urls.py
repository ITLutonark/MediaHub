...
urlpatterns = [
    ...
    path(
        'article/',
        include('articleapp.urls', namespace='article'),
        name='article',
    ),
    path(
        'account/',
        include('persaccapp.urls', namespace='account'),
        name='account',
    ),
    path(
        'comment/',
        include('commentapp.urls', namespace='comment'),
        name='comment',
    ),
    ...
    path(
        'search/',
        include('searchapp.urls', namespace='search'),
        name='search',
    ),
